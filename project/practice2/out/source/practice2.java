...
public void ball(int x,int y,int ballcolor)
{
  switch(ballcolor)
  {
...
int dx,dy;
public boolean hitball(int bx,int by,int wi,int hi)
{
...
public boolean hitwall(int bx,int by,int mode)
{
  switch(mode)
  {
    case 1:
...
public void draw()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "practice2" };
    if (passedArgs != null) {
