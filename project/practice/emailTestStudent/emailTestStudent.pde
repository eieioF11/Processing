...
String hostIP = "172.16.30.177";
String mailAddress = "test001@acpTMCIT.com";
String mailSource = "T4_40@acpTMCIT.com";
String sender = "Okada";
String mailSubject = "Report";
String mailMessage = "Hello, I'm Okada. I have worked up my task.";
...
void keyPressed() {
  if (key == '1') {            //Send
     ...
     textSize(15);
     text("Sorry, not implemented.", 300, 140);
