...
void setup(){
  size( 600, 400 );
 img = loadImage( “../../image/meguro_river.jpg" );
  imageMode(CORNER);
  frameRate(60); 

//File open
  String[] lines=loadStrings(“../../data/output5.txt");  
//  String[] lines=loadStrings(“/data/position2.csv");  
...
void draw(){
  ...
  if(i<number){
    ...
    img( photo,-x+width/2,-y+height/2 );
  }
}
